...
//  A: "this" refers to the specfic object on which the method scope is being called. 
// 2. What is "this" when joe.scopeArrow() is invoked?
//  A: It looks like "this" refers to the Window object, not an instantiation of a Student.
// 3. Explain why "this" is different when an arrow function is used.
//  A: "this" is different when an arrow function is called because the scope of arrow functions
//      bubble up to the next nearest scope. The "this" declared in arrow functions therefore 
//      is not confined to the context of a specific instantiation of an object.
